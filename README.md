...
<div align="center">
  <div style="display:inline-block; width:100%; max-width:760px; background:linear-gradient(135deg,#0d0a1a,#1a1030); border:1px solid #2a1f47; border-radius:20px; padding:18px; box-shadow:0 16px 36px rgba(138,43,226,.28);">
    ...
    <div style="display:flex; align-items:center; gap:18px;">
      <a href="https://open.spotify.com/track/6KfugJFINWqA42k59hmjFr"><img src="https://i.scdn.co/image/ab67616d00001e0210df7b8e9b3ed2588888a8ae" alt="cover" height="96" style="border-radius:14px; box-shadow:0 8px 20px rgba(138,43,226,.35)"/></a>
      <div style="flex:1; line-height:1.35;">
        <div style="font-weight:800; font-size:18px;"><a href="https://open.spotify.com/track/6KfugJFINWqA42k59hmjFr" style="color:#cdb8ff; text-decoration:none;">TABOLA BALE</a></div>
        <div style="color:#b9a5ff; opacity:.9; margin-top:2px;">Silet Open Up, Jacson Seran, Juan Reza, Diva Aurel</div>
    ...
    <div style="margin-top:14px; width:100%; height:8px; background:#2a2140; border-radius:999px; overflow:hidden;">
      <div style="height:8px; width:88%; background:linear-gradient(90deg,#8A2BE2,#BC7CFF);"></div>
    </div>
    <div style="display:flex; justify-content:space-between; margin-top:6px; font-size:12px; color:#b9a5ff; opacity:.82;">
      <span>4:01</span><span>4:34</span>
    </div>
  </div>
</div>
<!--SPOTIFY_END-->
...
<p align="right">
  <sub><span id="last-updated"><!--LAST_UPDATE-->Last updated: 13/01/2026 20:50 WIB<!--/LAST_UPDATE--></span></sub>
</p>
