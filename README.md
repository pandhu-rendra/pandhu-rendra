...
<div align="center">
  <div style="display:inline-block; width:100%; max-width:760px; background:linear-gradient(135deg,#0d0a1a,#1a1030); border:1px solid #2a1f47; border-radius:20px; padding:18px; box-shadow:0 16px 36px rgba(138,43,226,.28);">
    ...
    <div style="display:flex; align-items:center; gap:18px;">
      <a href="https://open.spotify.com/track/6nGeLlakfzlBcFdZXteDq7"><img src="https://i.scdn.co/image/ab67616d00001e024ae8ff731c49965bf2083405" alt="cover" height="96" style="border-radius:14px; box-shadow:0 8px 20px rgba(138,43,226,.35)"/></a>
      <div style="flex:1; line-height:1.35;">
        <div style="font-weight:800; font-size:18px;"><a href="https://open.spotify.com/track/6nGeLlakfzlBcFdZXteDq7" style="color:#cdb8ff; text-decoration:none;">Love Story</a></div>
        <div style="color:#b9a5ff; opacity:.9; margin-top:2px;">Indila</div>
